...
<div>
    <!-- End Breadcrumb -->
    <h2 class="heading-medium"><g:message code="admin.import.sitemap.label" default=""/></h2>

    <div class="row">
        <p class="col-md-8 lead"><g:message code="admin.import.sitemap.lead"/></p>
        <p class="col-md-4 well"><g:message code="admin.import.swap"/></p>
    </div>

    <div>
        <button id="start-import" onclick="javascript:buildSitemap()"
                class="btn btn-primary import-button"><g:message code="admin.button.buildsitemap"/></button>
    </div>
    <div>
    ...
    <asset:script type="text/javascript">
        function buildSitemap(){
            loadInfo("${createLink(controller:'import', action:'buildSitemap')}?online=" + $('#use-online').is(':checked'));
        }
    </asset:script>
</div>
</body>
